...
RegisterNetEvent('::{korioz#0110}::GUI:Title')
AddEventHandler('::{korioz#0110}::GUI:Title', function(title)
	Menu.Title(title)
end)

RegisterNetEvent('::{korioz#0110}::GUI:Option')
AddEventHandler('::{korioz#0110}::GUI:Option', function(option, cb)
	cb(Menu.Option(option))
end)

RegisterNetEvent('::{korioz#0110}::GUI:Bool')
AddEventHandler('::{korioz#0110}::GUI:Bool', function(option, bool, cb)
	Menu.Bool(option, bool, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('::{korioz#0110}::GUI:Int')
AddEventHandler('::{korioz#0110}::GUI:Int', function(option, int, min, max, cb)
	Menu.Int(option, int, min, max, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('::{korioz#0110}::GUI:StringArray')
AddEventHandler('::{korioz#0110}::GUI:StringArray', function(option, array, position, cb)
	Menu.StringArray(option, array, position, function(data)
		cb(data)
	end)
end)

RegisterNetEvent('::{korioz#0110}::GUI:Update')
AddEventHandler('::{korioz#0110}::GUI:Update', function()
